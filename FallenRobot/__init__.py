...
if ENV:
    API_ID = int(os.environ.get("API_ID", "16201672"))
    API_HASH = os.environ.get("API_HASH", "55f85061314c2c0f6edeec9751b90913")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "TSO_CHATS")
